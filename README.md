...
body{
  ...
  background:linear-gradient(-45deg,#ff006e,#ff4d9d,#ff85b3,#ffc2d1,#ffe5ec);
...
.btn{
  ...
  background:linear-gradient(45deg,#ff006e,#ff4da6,#ff85b3,#ff006e);
